...
const ID = "123";
const SOURCE_FILE = "companyWiseQuestions/Atlasssian/123_Best_Time_to_Buy_and_Sell_Stock_III.json";
const TARGET_FILENAME = "123_Best_Time_to_Buy_and_Sell_Stock_III.json";
