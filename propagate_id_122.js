...
const ID = "122";
const SOURCE_FILE = "companyWiseQuestions/Goldman Sachs/122_Best_Time_to_Buy_and_Sell_Stock_II.json";
const TARGET_FILENAME = "122_Best_Time_to_Buy_and_Sell_Stock_II.json";
