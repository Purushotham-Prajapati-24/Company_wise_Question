...
if __name__ == '__main__':
    ...
    if data:
        # Check if input is wrapped in quotes (standard for some test harnesses)
        ...
        # Replace literal \\n and \\t if they were passed that way
        data = data.replace('\\\\n', '\\n').replace('\\\\t', '\\t')
...
int main() {
    ...
    // Simple unescape for \\n and \\t if provided as literal strings
    string input = "";
...
public class Main {
    public static void main(String[] args) {
        ...
        // Handle escaped sequences and quotes
        input = input.replace("\\\\\\\\n", "\\n").replace("\\\\\\\\t", "\\t");
