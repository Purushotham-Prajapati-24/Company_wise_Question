...
4. **Complexity**:
   - O(1) time and O(1) space."""
    ...
    boilerplate = {
        "python": "import sys\n\ndef computeArea(ax1, ay1, ax2, ay2, bx1, by1, bx2, by2):\n    # User logic\n    pass\n\nif __name__ == '__main__':\n    data = sys.stdin.read().split()\n    if len(data) < 8: sys.exit()\n    print(computeArea(*(map(int, data))))",
        "cpp": "int computeArea(int ax1, int ay1, int ax2, int ay2, int bx1, int by1, int bx2, int by2) { /* logic */ return 0; }",
        "java": "public int computeArea(int ax1, int ay1, int ax2, int ay2, int bx1, int by1, int bx2, int by2) { /* logic */ return 0; }",
        "javascript": "var computeArea = function(ax1, ay1, ax2, ay2, bx1, by1, bx2, by2) { /* logic */ };",
        "c": "int computeArea(int ax1, int ay1, int ax2, int ay2, int bx1, int by1, int bx2, int by2) { /* logic */ return 0; }"
    }
