...
const ID = "116";
const SOURCE_FILE = "companyWiseQuestions/Visa/116_Populating_Next_Right_Pointers_in_Each_Node.json";
const TARGET_FILENAME = "116_Populating_Next_Right_Pointers_in_Each_Node.json";
